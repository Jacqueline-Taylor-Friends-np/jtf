                ...
                <div className="copyright-area">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6 col-sm-6">
                                <p>Copyright &copy;{currentYear} <a href="https://jacquelinetaylorandfriends.org" target="_blank" rel="noreferrer">Jacqueline Taylor & Friends. All Rights Reserved!</a></p>
                            </div>
